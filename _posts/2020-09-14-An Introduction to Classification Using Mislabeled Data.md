...
{% include figure.html path="assets/img/noise_label/30p.png" class="img-fluid rounded z-depth-1 mx-auto d-block" caption="Figure 1: Impact of 30% label noise on LinearSVC"%}
...
{% include figure.html path="assets/img/noise_label/ClfvsNoise.png" class="img-fluid rounded z-depth-1 mx-auto d-block" caption="Figure 2: Performance comparison of classifiers trained with original (i.e. clean) and noisy labels."%}
...
{% include figure.html path="assets/img/noise_label/large_sample.png" class="img-fluid rounded z-depth-1 mx-auto d-block" caption="Figure 3: Same as Figure 1 but with 4000 samples"%}
...
{% include figure.html path="assets/img/noise_label/DT.png" class="img-fluid rounded z-depth-1 mx-auto d-block" caption="Figure 4: Left, DT trained with clean label. Right, DT trained with noisy labels."%}
...
{% include figure.html path="assets/img/noise_label/ada.gif" class="img-fluid rounded z-depth-1 mx-auto d-block" caption="Figure 5: Weight distribution between clean and mislabeled samples in Adaboost"%}
...
{% include figure.html path="assets/img/noise_label/Reg.png" class="img-fluid rounded z-depth-1 mx-auto d-block" caption="Figure 6: Classification Performance at different regularization strength on Breast Cancer dataset corrupted with 25% label noise."%}
